# Generated by Django 2.2.1 on 2019-05-26 19:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('d', '草稿'), ('p', '已发布')], default='p', max_length=1, verbose_name='文章发布状态')),
                ('view_num', models.PositiveIntegerField(default=0, verbose_name='浏览次数')),
                ('allow_comment', models.BooleanField(default=False, verbose_name='是否允许评论')),
                ...
                ('tags', models.ManyToManyField(blank=True, to='myapp.Tag', verbose_name='标签')),
            ],
            options={
                'verbose_name': '文章',
